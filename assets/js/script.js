...
function openSocial(type) {
  ...
  switch (type) {
    case 'discord':
      url = 'https://discord.com/users/259380197634080770';
      break;
    case 'github':
      url = 'https://github.com/gxstavo31';
      break;
    case 'twitter':
      url = 'https://twitter.com/ImGuh1';
      break;
    case 'youtube':
      url = 'https://www.youtube.com/channel/UCgt6SudTNN53eyzqXYS5dhQ';
      break;
  }
...
function switchScreen() {
  document.title = 'GustavoNeris.me | home';
  ...
  ['tela', 'rain'].forEach(function (audioName) {
